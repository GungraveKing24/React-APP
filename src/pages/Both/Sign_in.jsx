      ...
      <div className="flex min-h-fit flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          ...
          <form onSubmit={handleSubmit} method="POST" className="space-y-6">
            ...
            <div>
                <button
                    type="submit"
                    className="flex w-full justify-center rounded-md bg-red-300 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                    Registrate
                </button>
            </div>
        </form>
