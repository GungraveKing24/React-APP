export default function Footer(){
    return (
      <footer className="bg-[#B9A387] text-white p-8 mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><a href="#" className="text-white-400 hover:text-white">Contactanos</a></li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="#" className="text-white-400 hover:text-white">Términos y Condiciones</a></li>
                <li><a href="#" className="text-white-400 hover:text-white">Políticas de Privacidad</a></li>
              </ul>
            </div>
          </div>
